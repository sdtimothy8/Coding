...
# Import lib
from sysmonitor.core.unicorn_actions import UnicornActions
from sysmonitor.core.unicorn_logging import logger


class UnicornPlugin(object):

    """Main class for  plugin."""

    def __init__(self, args=None, items_history_list=None):
        """Init the plugin of plugins class."""
        # Plugin name (= module name without )
        self.plugin_name = self.__class__.__module__[len('unicon_'):]
    ...
    def input_method(self, input_method):
        ...
        * Unicon: Client server mode via Unicon API
        """
