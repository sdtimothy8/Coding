...
# Import Glances lib
from sysmonitor.core.unicorn_globals import is_py3
from sysmonitor.core.unicorn_logging import logger
from sysmonitor.plugins.unicorn_batpercent import Plugin as BatPercentPlugin
from sysmonitor.plugins.unicorn_hddtemp import Plugin as HddTempPlugin
    ...
    def update(self):
        ...
        if self.input_method == 'local':
            ...
            try:
                ...
                # Append Batteries %
                self.stats.eglancesgrabsensorsxtend(batpercent)
