...
# Import lib
from sysmonitor.core.unicorn_globals import is_bsd, is_linux, is_mac, is_windows
from sysmonitor.core.unicorn_logging import logger
from sysmonitor.core.unicon_timer import Timer, getTimeSinceLastUpdate
...
class UniconProcesses(object):
    ...
    def __init__(self, cache_timeout=60):
        ...
        # Tag to enable/disable the processes stats (to reduce the  CPU consumption)
...
unicon_processes = UniconProcesses()
