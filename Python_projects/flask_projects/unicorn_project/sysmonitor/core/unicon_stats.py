...
from sysmonitor.core.unicorn_globals import exports_path, plugins_path, sys_path
...
class UniconStatsServer(UniconStats):

    """This class stores, updates and gives stats for the server."""

    def __init__(self, config=None):
        # Init the stats
        UniconStats.__init__(self, config)
...
class UniconStatsClient(UniconStats):

    """This class stores, updates and gives stats for the client."""

    def __init__(self, config=None, args=None):
        """Init the UniconStatsClient class."""
        # Init the plugin list dict
        self._plugins = collections.defaultdict(dict)
...
class UniconStatsClientSNMP(UniconStats):
