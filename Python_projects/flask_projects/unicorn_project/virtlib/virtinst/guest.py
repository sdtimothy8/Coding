...
class Guest(XMLBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.default_graphics_type = "vnc"
    ...
    def _get_os_variant(self):
        name = ''
        try:
            name = self._os_object.name
        except:
            pass
        return name #self._os_object.name
    ...
    def _set_clock_defaults(self):
        ...
        # self._os_object.is_windows() and 
    ...
    def _set_feature_defaults(self):
        ...
        default = True
        # self._os_object.need_old_xen_disable_acpi() and
            ...
            if self.os.is_arm_machvirt():
                ...
                d.bus = "scsi"
                  ...
                  (self._hv_only_supports_virtio() or
                   (self._hv_supports_virtio()))):
             # and self._os_object.supports_virtiodisk()
                d.bus = "virtio"
    ...
    def _set_net_defaults(self):
        ...
        if not self.os.is_hvm():
            net_model = None
              ...
              (self._hv_supports_virtio())):
         # and self._os_object.supports_virtionet()
            net_model = "virtio"
        else:
            try:
    ...
    def _set_input_defaults(self):
        ...
        input_type = "mouse" #self._os_object.default_inputtype()
        input_bus = "usb" #self._os_object.default_inputbus()
        if self.os.is_xenpv():
    ...
    def _set_video_defaults(self):
        ...
        video_model = 'vga' #self._os_object.default_videomodel(self)
